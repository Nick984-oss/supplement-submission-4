...
Tab.~\ref{tab:anhang-a} dokumentiert das final konsolidierte Codesystem der qualitativen Inhaltsanalyse \parencite{mayring2014} sowie die systematische Ableitung der 18 Self-Assessment-Items (einheitliche Antwortskala von 0 bis 5). Jedem Kriterium ist genau ein eindeutiger Code und genau ein Item zugeordnet. Die Literaturanker belegen die Verankerung im wissenschaftlichen Schrifttum, wobei methodisch zwischen direkten Bezügen und theoriegeleiteten, artefaktbezogenen Operationalisierungen unterschieden wird.

\begin{longtblr}[
  caption={Konsolidierter Codierleitfaden und vollständige Item-Traceability (C01--C18); Quelle: Eigene Darstellung},
  label={tab:anhang-a},
  entry=none
]{
  width=\textwidth,
...
Die Taxonomieentwicklung folgte der DSR-orientierten Methodik nach \textcite{nickerson2013} im ersten Konstruktionszyklus \parencite{hevner2004, peffers2007} unter Berücksichtigung etablierter Reifegradmodell-Entwicklungsprinzipien \parencite{becker2009, debruin2005, poeppelbus2011}. Als Meta-Charakteristikum wurde der \textit{Grad organisationaler und interorganisationaler Fähigkeit zur selbstbestimmten, kontrollierten und verantwortungsvollen Gestaltung digitaler Ressourcen in föderierten Bildungsökosystemen} festgelegt. Tab.~\ref{tab:anhang-b} dokumentiert die erhaltenen Entwicklungsstände von den initialen Literaturkonstrukten über die konsolidierten Zwischendimensionen bis zur finalen sechsteiligen Taxonomie. Die Übergänge stellen eine transparente, modelltheoretische Rekonstruktion auf Basis der erhaltenen Artefaktstände dar; ein historisch lückenloses Sitzungs- oder Diskussionsprotokoll wird ausdrücklich nicht beansprucht.

\begin{longtblr}[
  caption={Retrospektiv rekonstruierte Konsolidierungslogik aus erhaltenen Artefaktständen; Quelle: Eigene Darstellung},
  label={tab:anhang-b},
  entry=none
]{
  width=\textwidth,
...
\begin{longtblr}[
  caption={Traceability-Matrix der Designanforderungen (DA1--DA6); Quelle: Eigene Darstellung},
  label={tab:anhang-c},
  entry=none
]{
  width=\textwidth,

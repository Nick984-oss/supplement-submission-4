...
Dieses Dokument stellt das begleitende Online-Supplement zum Manuskript bereit. Anhang~A dokumentiert den final konsolidierten Codierleitfaden der qualitativen Inhaltsanalyse (methodisch angelehnt an \textcite{mayring2014}) zur Sicherung der konzeptionellen Nachvollziehbarkeit und inhaltlichen Plausibilität der Kriterien und Items, nicht als nachträglich fingiertes Echtzeit-Codierprotokoll der historischen Zwischenschritte. Die Tabelle weist die dokumentierte Kette von den literaturbasierten Konzepten über Dimensionen und Kriterien bis zu den 18 Self-Assessment-Items lückenlos aus (zur methodischen Traceability, ohne empirischen Inhaltsvaliditätsanspruch). Anhang~B bietet eine transparente, modelltheoretische Rekonstruktion der erhaltenen Entwicklungsstände der Taxonomieentwicklung im ersten Design-Science-Research-Zyklus (DSR-Zyklus) sowie die formativen Qualitäts- und Abbruchkriterien, ohne ein historisch lückenloses Sitzungs- oder Diskussionsprotokoll zu beanspruchen. Anhang~C fasst die interne, konzeptionelle Ex-ante-Evaluation der sechs Designanforderungen (DA1--DA6) zusammen. Das Supplement weist die interne Traceability und strukturelle Kohärenz des Modells aus; es beansprucht weder eine empirische Evaluation realer Organisationen noch einen psychometrischen Validitätsnachweis.

\vspace{0.6em}
\section*{Anhang A: Codierleitfaden und Item-Traceability}
\label{sec:anhang-a}

Tabelle~\ref{tab:anhang-a} dokumentiert das final konsolidierte Codesystem der qualitativen Inhaltsanalyse sowie die systematische Ableitung der 18 Self-Assessment-Items (einheitliche Antwortskala von 0 bis 5). Jedem Kriterium ist genau ein eindeutiger Code und genau ein Item zugeordnet. Die Literaturanker belegen die Verankerung im wissenschaftlichen Schrifttum, wobei methodisch zwischen direkten Bezügen und theoriegeleiteten, artefaktbezogenen Operationalisierungen unterschieden wird.
...
C-KOM-03 & \textbf{Kompetenz und organisationale Fähigkeiten}\newline Lernfähigkeit & \textbf{Def.:} Fähigkeit, Projekterfahrungen und Evaluationen systematisch zu reflektieren und in institutionelle Anpassungen zu überführen.\newline \textbf{Ein.:} Feedbackschleifen, Reflexion, kontinuierliche Verbesserung.\newline \textbf{Abgr.:} Einmalige Maßnahmen ohne systematische Rückkopplung. & Indirekter methodischer Literaturanker für wiederkehrende Evaluation, Reflexion und Anpassung (S.~704; \parencite{stoiber2023}); die Übertragung auf die systematische Nutzung von Projekterfahrungen stellt eine artefaktbezogene Operationalisierung dar. & \textbf{Erfahrungen aus digitalen Projekten werden systematisch ausgewertet und genutzt.}\newline \textit{Ableitung:} Erfasst eine beobachtbare organisationale Lern- und Verbesserungsschleife. \\
...
Die Taxonomieentwicklung folgte der DSR-orientierten Methodik nach \textcite{nickerson2013} im ersten Konstruktionszyklus \parencite{hevner2004, peffers2007} unter Berücksichtigung etablierter Reifegradmodell-Entwicklungsprinzipien \parencite{becker2009, debruin2005, poeppelbus2011}. Als Meta-Charakteristikum wurde der \textit{Grad organisationaler und interorganisationaler Fähigkeit zur selbstbestimmten, kontrollierten und verantwortungsvollen Gestaltung digitaler Ressourcen in föderierten Bildungsökosystemen} festgelegt. Tabelle~\ref{tab:anhang-b} dokumentiert die erhaltenen Entwicklungsstände von den initialen Literaturkonstrukten über die konsolidierten Zwischendimensionen bis zur finalen sechsteiligen Taxonomie. Die Übergänge stellen eine transparente, modelltheoretische Rekonstruktion auf Basis der erhaltenen Artefaktstände dar; ein historisch lückenloses Sitzungs- oder Diskussionsprotokoll wird ausdrücklich nicht beansprucht.

\begin{longtblr}[
  caption={Retrospektiv rekonstruierte Konsolidierungslogik aus erhaltenen Artefaktständen},
  label={tab:anhang-b},
  entry=none
]{
  width=\textwidth,
...
Stand 2\newline (Zwischenstand) & 12 vorläufige Konstrukte aus Stand 1 mit Bezug zu institutionellen und vernetzten Anforderungen. & Zusammenführung zu 8 Zwischenbereichen zur thematischen Vorstrukturierung zentraler Handlungsfelder. & Zentralbereiche abgebildet; noch bestehende enge thematische Kopplung zwischen Interoperabilität und Föderation. \\

Stand 3\newline (final) & 8 Zwischenbereiche aus Stand 2. & Zusammenführung verwandter Bereiche zu den finalen 6 Dimensionen mit je 3 Kriterien (inkl. Vertrauens- und Lernaspekten). & \textbf{6 Dimensionen mit je genau 3 Kriterien (18 Kriterien).} Die Symmetrie ist eine bewusste Designentscheidung für ein kompaktes Self-Assessment, kein empirischer Naturgesetzlichkeitsbeweis. \\
\bottomrule
\end{longtblr}

\vspace{0.4em}
\textbf{Qualitätskriterien und Konsistenzprüfung:} Das MECE-Prinzip (mutually exclusive, collectively exhaustive) wurde als heuristisches Leitbild zur Minimierung semantischer Überschneidungen angewendet; eine empirisch bewiesene vollständige Disjunktheit oder Erschöpfung wird nicht behauptet. Die formativen Qualitätskriterien (\textit{Verständlichkeit}, \textit{Trennschärfe}, \textit{thematische Vollständigkeit relativ zum Korpus}, \textit{Operationalisierbarkeit} und \textit{Erweiterbarkeit}) wurden im abschließenden Revisionsschritt dokumentenbasiert als theoriegeleitete Prüfdimensionen angewendet. Im Zuge der Überarbeitung zeigte eine dokumentenbasierte Konsistenzprüfung, dass die sechs Dimensionen und 18 Kriterien in der vorliegenden Fassung stabil zugeordnet sind. Diese Prüfung dokumentiert die Konsistenz des erhaltenen Artefaktstands, stellt jedoch keine nachträglich rekonstruierte historische Abbruchbedingung des ursprünglichen Entwicklungsprozesses dar.
